        ...
        <div className="w-full min-h-screen relative bg-[#F7F5F3] overflow-x-hidden flex flex-col justify-start items-center">
            <div className="relative flex flex-col justify-start items-center w-full h-full min-h-screen">
                ...
                <div className="md:px-8 lg:px-0 w-[94vw] md:w-6xl max-w-6xl relative flex flex-col justify-center items-center grow border-l border-r border-[#E0DEDB]/80 bg-[#F7F5F3]">
                    <div className='border-b py-28 border-t border-[#E0DEDB]/80 w-full'>
                        <div className="flex flex-col items-center justify-center z-10 ">
                            <h1 className="text-[180px] font-bold text-neutral-800 leading-none">404</h1>
                            <h2 className="text-2xl font-semibold text-neutral-700 mb-1">Stran ni najdena</h2>
                            <p className="text-neutral-500 mb-4 max-w-md text-center">Stran, ki jo iščeš, ne obstaja.</p>
