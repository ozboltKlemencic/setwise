...
export default function NotFound() {
    return (
        <div className="w-full h-dvh md:h-screen relative bg-[#F7F5F3] [mask-image:radial-gradient(400px_circle_at_center,white,transparent)] md:[mask-image:radial-gradient(700px_circle_at_center,white,transparent)] overflow-x-hidden flex flex-col justify-start items-center">
                ...
                <div className="md:px-8 lg:px-0 w-[94vw] md:w-6xl max-w-6xl relative flex flex-col justify-center items-center grow border-l border-r border-[#E0DEDB]/80 bg-[#F7F5F3]">
                    <div className='border-b py-28 border-t border-[#E0DEDB]/80 w-full z-20'>
                        <div className="flex flex-col items-center justify-center z-10 ">
                            <h1 className="text-[140px] md:text-[220px] font-bold text-neutral-800 leading-none">404</h1>
            ...
            <div className="absolute bottom-0 bg-red-200 w-full h-[500px] md:h-[900px]  flex items-end justify-center overflow-hidden pointer-events-none">
                <ParticleText text="404" fontSize={460} fontSizeMobile={80} className="w-full h-full opacity-90 md:opacity-50 z-10" />
            </div>
        </div>
    )
}
