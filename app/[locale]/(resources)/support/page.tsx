    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-start font-sans md:pt-0 pt-8">
            <div className="w-full px-(--space-5) md:px-(--space-12) max-w-5xl ">
                ...
                {/* ── Cards Grid ───────────────────────────────── */}
                <div className="min-h-[600px] relative overflow-visible" style={{ marginLeft: 'calc(-50vw + 50%)', marginRight: 'calc(-50vw + 50%)', width: '100vw', maxWidth: '100vw' }}>
                    {/* Decorative background — full layout width */}
                    <div className="absolute inset-0 border-t border-surface-200/80 dark:border-surface-300/60 pointer-events-none overflow-hidden">
                    ...
                    {/* Cards centered within */}
                    <div className="relative z-10 flex justify-center px-(--space-5) md:px-(--space-12)">
                        <div className="grid md:grid-cols-2 gap-(--space-4) py-(--space-8) w-full max-w-3xl">
