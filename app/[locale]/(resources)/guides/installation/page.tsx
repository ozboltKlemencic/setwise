...
import { Check, Download, Smartphone, Laptop, RefreshCw, ShieldCheck } from "lucide-react"
import {
    FeatureCard,
    KeyFeatureSection,
    MiniFeatureCard,
...
const installationKeys = ['ios', 'android', 'desktop', 'troubleshooting'] as const
        ...
        <div className="w-full h-full flex flex-col items-center justify-start font-sans pt-0 md:pt-12 lg:pt-0">
            <div className="w-full px-(--space-5) md:px-(--space-12) max-w-5xl min-[1152px]:border-0 md:border-l md:border-r border-surface-200">
                ...
                <div className="space-y-(--space-10) md:space-y-(--space-16) lg:space-y-(--space-20) ">
                    ...
                    <section id="steps" className="scroll-mt-32 space-y-(--space-8) md:space-y-(--space-16)">
                        ...
                        {/* Feature 1 — iOS */}
                        <KeyFeatureSection icon={Smartphone} title={t('keyFeatures.ios.title')}>
                            <div className="space-y-(--space-3) md:space-y-(--space-4) max-w-prose">
                                <FeatureTextBlock lead={t('keyFeatures.ios.step1.lead')}>
                                    {t.rich('keyFeatures.ios.step1.text', richTextComponents)}
                                </FeatureTextBlock>
                                <FeatureTextBlock lead={t('keyFeatures.ios.step2.lead')}>
                                    {t.rich('keyFeatures.ios.step2.text', richTextComponents)}
                                </FeatureTextBlock>
                                <FeatureTextBlock lead={t('keyFeatures.ios.step3.lead')}>
                        ...
                        {/* Feature 2 — Android */}
                        <KeyFeatureSection icon={Smartphone} title={t('keyFeatures.android.title')}>
                            <div className="space-y-(--space-3) md:space-y-(--space-4) max-w-prose">
                                <FeatureTextBlock lead={t('keyFeatures.android.step1.lead')}>
                                    {t.rich('keyFeatures.android.step1.text', richTextComponents)}
                                </FeatureTextBlock>
                                <FeatureTextBlock lead={t('keyFeatures.android.step2.lead')}>
                                    {t.rich('keyFeatures.android.step2.text', richTextComponents)}
                                </FeatureTextBlock>
                                <FeatureTextBlock lead={t('keyFeatures.android.step3.lead')}>
                        ...
                        {/* Feature 3 — Desktop */}
                        <KeyFeatureSection icon={Laptop} title={t('keyFeatures.desktop.title')}>
                            <div className="space-y-(--space-3) md:space-y-(--space-4) max-w-prose">
                                <FeatureTextBlock lead={t('keyFeatures.desktop.step1.lead')}>
                                    {t.rich('keyFeatures.desktop.step1.text', richTextComponents)}
                                </FeatureTextBlock>
                                <FeatureTextBlock lead={t('keyFeatures.desktop.step2.lead')}>
                                    {t.rich('keyFeatures.desktop.step2.text', richTextComponents)}
                                </FeatureTextBlock>
                                <FeatureTextBlock lead={t('keyFeatures.desktop.step3.lead')}>
                        ...
                        <KeyFeatureSection icon={RefreshCw} title={t('keyFeatures.troubleshooting.title')}>
                            <div className="relative py-(--space-3) md:py-(--space-6)">
                                ...
                                <div className="grid md:grid-cols-2 gap-(--space-2) relative z-10">
                                    <MiniFeatureCard title={t('keyFeatures.troubleshooting.clearCache.lead')} description={t('keyFeatures.troubleshooting.clearCache.text')} />
                                    <MiniFeatureCard title={t('keyFeatures.troubleshooting.updateBrowser.lead')} description={t('keyFeatures.troubleshooting.updateBrowser.text')} />
                                    <MiniFeatureCard title={t('keyFeatures.troubleshooting.contactSupport.lead')} description={t('keyFeatures.troubleshooting.contactSupport.text')} />
                                    <MiniFeatureCard title={t('keyFeatures.troubleshooting.checkConnection.lead')} description={t('keyFeatures.troubleshooting.checkConnection.text')} />
                                </div>
                            </div>
                        </KeyFeatureSection>
                    ...
                    {/* GET STARTED Section */}
                    <section id="requirements" className="scroll-mt-32 space-y-(--space-6) md:space-y-(--space-12) mb-(--space-10) md:mb-(--space-20)">
                        <div className="space-y-(--space-2)">
                            <p className="text-caption-2 md:text-caption-1 uppercase tracking-wider font-semibold primaryGradient">
                                {t('getStarted.badge')}
                            </p>
