...
export default async function ChangelogPage() {
    ...
    const sections = ["v0_3_0", "v0_2_2", "v0_2_0", "v0_1_0"] as const
                    ...
                    <div className="space-y-(--space-6) md:space-y-(--space-8)">
                        {sections.map((section) => (
                            <div key={section} className="space-y-(--space-2) md:space-y-(--space-3)">
                                ...
                                <p className="text-footnote md:text-subheadline lg:text-callout text-surface-700 leading-relaxed max-w-prose whitespace-pre-line">
