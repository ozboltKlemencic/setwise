  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-(--sidebar-width) bg-transparent transition-[width] duration-[360ms] ease-[cubic-bezier(0.22,1,0.36,1)]",
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-[360ms] ease-[cubic-bezier(0.22,1,0.36,1)] md:flex",
          side === "left"
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn(
        "flex h-(--header-height) shrink-0 items-center border-b border-neutral-200 px-2 group-data-[collapsible=icon]:px-1",
        className
      )}
      {...props}
    />
...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn(
        "flex flex-col gap-2 p-2 group-data-[collapsible=icon]:px-1 group-data-[collapsible=icon]:py-2",
        className
      )}
      {...props}
    />
...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
      ...
      className={cn(
        "group/menu-item relative zgroup-data-[collapsible=icon]:flex group-data-[collapsible=icon]:justify-center",
        className
      )}
      {...props}
    />
