const ButtonRotatingGradient = () => {
    return (
        <button className='relative inline-flex h-12 overflow-hidden rounded-full p-[2px]  ease-in-out duration-300 focus:scale-95  '>
            ...
            <span className='relative inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full dark:bg-[#070e41] bg-blue-600 px-8 py-1 text-sm font-medium dark:text-neutral-50 text-white backdrop-blur-3xl'>
                Download
