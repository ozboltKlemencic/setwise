...
export function Iphone({
    ...
    return (
        ...
        >
            ...
            {children && (
                <div
                    className="absolute z-10 overflow-hidden bg-white dark:bg-black"
                    style={{
                        left: `${LEFT_PCT}%`,
                        top: `${TOP_PCT}%`,
                        width: `${WIDTH_PCT}%`,
            ...
            >
                <g mask={hasMedia ? `url(#${maskId})` : undefined}>
                    <path
                        ...
                        className="fill-[#404040] dark:fill-[#525252]"
                    />
                    <path
                        d="M0 171C0 170.448 0.447715 170 1 170H3V204H1C0.447715 204 0 203.552 0 203V171Z"
                        className="fill-[#262626] dark:fill-[#737373]"
                    />
                    <path
                ...
                <path
                    ...
                    className="fill-[#525252] dark:fill-[#737373]"
                />
                ...
                <path
                    ...
                    className="fill-[#f5f5f5] stroke-[#e5e5e5] stroke-[0.5] dark:fill-[#171717] dark:stroke-[#525252]"
