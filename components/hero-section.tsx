...
export default function HeroSection() {
  return (
    <div className="w-full max-w-[1050px] shadow-[rgba(55,50,47,0.12)] m-1 rounded-b-lg  px-16 overflow-hidden py-4 bg-linear-to-t from-blue-500/20 to-transparent mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
