...
export default function ComingSoon() {
    ...
    return (
        <div className="w-full h-dvh md:h-screen relative bg-surface-50 mask-[radial-gradient(300px_circle_at_center,white,transparent)] md:mask-[radial-gradient(560px_circle_at_center,white,transparent)] overflow-x-hidden flex flex-col justify-start items-center transition-colors duration-normal">
                    ...
                    <div className='border-b py-12 md:py-32 border-t flex items-center justify-center border-border w-full z-20 transition-colors duration-normal'>
                        <div className="flex flex-col items-center justify-center z-10 w-[94vw] text-center">
                            <motion.h1
                                ...
                                className="text-[60px] md:text-[100px] font-bold text-surface-900 leading-none tracking-tighter select-none px-4"
                            >
                                {t('title')}
                            </motion.h1>
                            <motion.div
            ...
            <div className="absolute bottom-0 w-full pb-10 h-[400px] md:h-[600px] flex items-end justify-center overflow-hidden pointer-events-none">
                <ParticleText
                    text={t('particleText')}
                    fontSize={300}
                    fontSizeMobile={120}
                    className="w-full h-full opacity-75 dark:md:opacity-40 md:opacity-100 z-10"
                />
            </div>
        </div>
    )
