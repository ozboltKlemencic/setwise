        ...
        <div className="h-auto w-full md:min-w-[380px] max-w-[380px] md:mr-(--space-16) p-(--space-4) md:p-(--space-8) pb-0 flex flex-col justify-start items-start gap-y-(--space-3)">
          ...
          <div className="flex flex-col gap-y-(--space-2)">
            ...
            <div className="flex items-center md:gap-x-(--space-3) gap-x-(--space-4)">
              <Link href="#" className="text-surface-500  hover:text-surface-800 transition-colors duration-(--duration-fast) ease-(--ease-apple)">
                <Instagram className="size-3.5 md:size-4 font-thin" />
              </Link>
              <Link href="#" className="text-surface-500  hover:text-surface-800 0 transition-colors duration-(--duration-fast) ease-(--ease-apple)">
                <Linkedin className="size-3.5 md:size-4 font-thin" />
              </Link>
              <Link href="#" className="size-3.5 md:size-4 text-surface-500 hover:text-surface-800  flex items-center justify-center transition-colors duration-(--duration-fast) ease-(--ease-apple)">
