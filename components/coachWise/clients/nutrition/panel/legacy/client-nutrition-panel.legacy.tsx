...
export type SmartGeneratedMeal = {
  id: string
  slot: string
  title: string
  calories: number
...
export const nutritionMealPlanSections: Record<string, NutritionMealPlanSection[]> = {
  "training-day": [
    {
      id: "breakfast",
      label: "Breakfast",
...
export function parseMealPlanMacros(macros: string) {
...
export function getNutritionPreset(phase?: string): NutritionPreset {
  switch (phase) {
    case "Bulk":
      {
